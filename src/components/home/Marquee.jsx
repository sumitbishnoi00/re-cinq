...
const Marquee = () => {
  return (
    <section className='bg-black pt-[125.46px] -mt-1'>
      <div className='max-w-361.75 mx-auto w-full flex items-center overflow-hidden flex-col pt-6 pb-2.25'>
        <h2 className='font-normal text-2xl leading-121 tracking-[-2%] text-center text-white/80 mb-10'>Trusted by hundreds of technology leaders from companies like</h2>
