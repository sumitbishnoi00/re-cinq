...
const Button = ({ children, vari, className = "" }) => {
  const variants = {
    pri: "font-medium lg:w-50.75 md:w-48 sm:w-44 w-42.25 lg:h-13.25 md:h-12 sm:h-11.5 h-11.25  border border-transparent  hover:border-border flex items-center justify-center",
    sec: "font-medium lg:w-52.75 md:w-50.5 sm:w-48.5 w-47.75 lg:h-13.25 md:h-12 sm:h-11.5 h-11.25 border border-border flex items-center justify-center",
