...
const Button = ({children, vari, className = "" }) => {
    const variants = {
        pri: "font-medium w-50.25 h-12.75 border border-none bg-[linear-gradient(91.05deg,#8E2EE0_7.21%,#AF7EF4_86.3%)] hover:scale-105 hover:bg-transparent flex items-center justify-center",
        sec: "font-medium w-52.25 h-12.75 border border-border bg-transparent hover:scale-105 hover:bg-[linear-gradient(91.05deg,#8E2EE0_7.21%,#AF7EF4_86.3%)] flex items-center justify-center",
