...
const Button = ({children, vari, className = "" }) => {
    const variants = {
        ...
        sec: "font-medium lg:w-52.25 md:w-50.5 sm:w-48.5 w-47.25 lg:h-12.75 md:h-12 sm:h-11.5 h-10.75 border border-border bg-white/6 hover:scale-105 hover:bg-[linear-gradient(91.05deg,#8E2EE0_7.21%,#AF7EF4_86.3%)] flex items-center justify-center",
        ...
        out: "font-normal lg:py-4 md:py-3.75 sm:py-3.25 py-3  lg:px-8.25 md:px-7.5 sm:px-7 max-[400px]:px-4 px-6.25 whitespace-nowrap border border-border bg-white/6 hover:scale-105 hover:bg-[linear-gradient(91.05deg,#8E2EE0_7.21%,#AF7EF4_86.3%)]",
